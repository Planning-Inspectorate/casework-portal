...
export function configureNunjucks() {
	...
	// get the path to the @pins/casework-portal-lib folder, in node_modules, using the node require resolution
	const libUi = path.resolve(require.resolve('@pins/casework-portal-lib'), '..');
