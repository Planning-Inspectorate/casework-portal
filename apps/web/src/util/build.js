...
import { runBuild } from '@pins/casework-portal-lib/util/build.js';
...
async function run() {
	...
	await runBuild({ staticDir: config.staticDir, srcDir: config.srcDir, repoRoot, accessibleAutocompleteRoot });
}
